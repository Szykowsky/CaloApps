...
namespace Calo.Infrastructure.Migrations
{
    ...
    [Migration("20220605182826_AddDailyStatus")]
    partial class AddDailyStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calo.Domain.Entities.DailyStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("KcalConsumed")
                        .HasColumnType("int");

                    b.Property<int>("KcalRemaining")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Calo.Domain.Entities.MetabolicRate.MetabolicRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Calo.Core.Entities.Meal", b =>
                {
                    b.HasOne("Calo.Domain.Entities.DailyStatus", "DailyStatus")
                        .WithMany("Meals")
                        .HasForeignKey("DailyStatusId");
